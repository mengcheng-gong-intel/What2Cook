...
INSERT INTO what2cook_dev.FoodCategories(id, foodcategory_id, foodcategory_name) VALUES 	(1, 1, 'main dishes'), 
																						...
																						(3, 3, 'pop food'), 
																						(4, 4, 'salad');
INSERT INTO what2cook_dev.Foods(id, food_id, food_name, foodcategory_id, createdate, author_id) VALUES 	(1, 1, 'Fired Chicken', 3, '2021-01-16 00:00:00+00:00', 1),
																									(2, 2, 'French Fries', 3, '2021-01-15 00:00:00+00:00', 2),
																									(3, 3, 'Jumbo Shrimp', 1, '2021-01-14 10:00:00+00:00',3),
																									(4, 4, 'Hearty Fall Soup', 2, '2021-01-13 11:30:00+00:00', 2),
																									(5, 5, 'Caesar Salad', 4, '2021-01-15 10:00:00+00:00', 3),
																									(6, 6, 'Classic Meatball', 1, '2021-01-12 10:00:00+00:00', 1),
																									(7, 7, 'Cucumber and Onion Salad', 4, '2021-01-15 08:00:00+00:00',2);
