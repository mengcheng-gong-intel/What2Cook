...
ALTER TABLE "FoodMaterial" ADD FOREIGN KEY ("food_id") REFERENCES "Foods" ("food_id");

ALTER TABLE "FoodMaterial" ADD FOREIGN KEY ("material_id") REFERENCES "Materials" ("material_id");
